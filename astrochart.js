...
(function( astrology ) {
	...
	astrology.Radix.prototype.drawAxis = function(){
		...
		[AS,IC,DC,MC].forEach( function(i) {
			...
			// overlap
			startPosition = astrology.utils.getPointPosition( this.cx, this.cy, this.radius, this.data.AIDM[i] + this.shift);
			endPosition = astrology.utils.getPointPosition( this.cx, this.cy, axisRadius, this.data.AIDM[i] + this.shift);
			...
			// As
		 	if(i == AS){
				console.log(this.data.AIDM[i])
		 		// Text
		 		textPosition = astrology.utils.getPointPosition( this.cx, this.cy, axisRadius + (20 * astrology.SYMBOL_SCALE), this.data.AIDM[i] + this.shift);
		 	...
		 	if(i == DC){
		 		// Text
		 		textPosition = astrology.utils.getPointPosition( this.cx, this.cy, axisRadius + (2 * astrology.SYMBOL_SCALE), this.data.AIDM[i] + this.shift);
		 	...
		 	if(i == IC){
		 		// Text
		 		textPosition = astrology.utils.getPointPosition( this.cx, this.cy, axisRadius + (10 * astrology.SYMBOL_SCALE), this.data.AIDM[i] - 2 + this.shift);
