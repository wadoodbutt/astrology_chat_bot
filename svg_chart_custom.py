...
# EDITED ORIGINAL TO CHANGE HOUSE POSITIONS AND ATTRIBUTE COLORS
...
class MakeSvgInstancePlacidus:
        ...
        for i in range(xr):
            ...
            if i + 2 != 13:
                ...
                ytext = self.__sliceToY(
                    0, (r-dropin), text_offset) + dropin  # was 132
                path = path + '<text style="fill: #f00; fill-opacity: .6; font-size: 20px"><tspan x="' + \
                    str(xtext-3)+'" y="'+str(ytext+3) + \
                    '">'+str(i+2)+'</tspan></text>'
            elif i + 2 > 12:
                xtext = self.__sliceToX(
    ...
    def __makeAspects(self, r, ar):
        ...
        for element in self.aspects_list:
            self.colors_settings['zodiac_bg_1'] = '#44f035'
            self.colors_settings['zodiac_bg_2'] = '#edf035'
            self.colors_settings['zodiac_bg_5'] = '#44f035'
            self.colors_settings['zodiac_bg_6'] = '#edf035'
            self.colors_settings['zodiac_bg_9'] = '#44f035'
            self.colors_settings['zodiac_bg_10'] = '#edf035'
    ...
    def __makeElements(self, r):
        ...
        # out += '<text y="12" style="fill:#61d428; font-size: 10px;">' + \
        #     self.language_settings['earth']+' '+str(pe)+'%</text>'
        # out += '<text y="24" style="fill:#f5e942; font-size: 10px;">' + \
    ...
    def __makePlanetGrid(self):
        ...
        out += '<g transform="translate(85, -15)">'
        out += \
            f'<text text-anchor="end" style="fill:{self.colors_settings["paper_0"]}; font-size: 14px;">{"Planets of"} {self.name}:</text>'
        out += '</g>'
    ...
    def __makeHousesGrid(self):
        ...
        #         self.houses_list[i]["position"] = 0.0
        #     if i < 9:
        #         cusp = '&#160;&#160;'+str(i+1)
        #     else:
        #         cusp = str(i+1)
        ...
        #         self.colors_settings['paper_0'], self.__dec2deg(0.0))
        #     out += '</g>'
        #     li = li + 14
        out += '</g>'
...
if __name__ == "__main__":
    ...
    name = MakeSvgInstancePlacidus(first, chart_type="Composite",
